...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = AssetRadarConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(AssetRadarDbContext context)
    {
        _context = context;
    }
