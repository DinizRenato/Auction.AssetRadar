...
using Auction.AssetRadar.Models.TokenAuth;
...
public abstract class AssetRadarWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static AssetRadarWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(AssetRadarWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<AssetRadarDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<AssetRadarDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<AssetRadarDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<AssetRadarDbContext, Task<T>> func)
    {
        T result;
